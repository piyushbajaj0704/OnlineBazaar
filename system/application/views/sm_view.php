...
<title>Sales Manager: Online Bazaar</title>
</head>
	<body onload="init();">		
	...
	<div class="container">
                ...
                <div class="innermain" style="width:880px;">  
                             <div class="mainsection"> 
                              ...
                              Allocate Customers to Different Regional Manager</p>
                            </div>
                 </div>
         ...
         <td><p class="query">PurchaseID </p></td> 
          <td><p class="query">Customer's Name</p></td>
           <td><p class="query">Discount Quotated</p></td>
        <td><p class="query">Regional Manager </p></td> 
  ...
  <tr> 
       ...
       <td>
		<p class="query"><?php if(isset($var['discount']))  echo $var['discount'] . "%"; ?></p>
      </td>
          ...
          <td style="width:200px">
               <?php 
							...
							echo form_open('http://localhost/onlinebazaar/index.php/fetchtag/assign_rm'); ?>
             <select name="regional_manager">
		    <?php		foreach($data2 as $var2) {  
			 if(isset($var2['fname'])) { ?>
             <p class="query">
			 <?php    echo "<option value=" .  $var2['rm_id'] . "<option>";   ?>    
             <?php    echo $var2['fname'] . " ". $var2['lname'];  }  }  ?>  </p> 
           </select>
             </td>
             
            <td> 
            <input type="hidden" name="customer_id" value="<?php echo $var['c_id'];  ?>">
